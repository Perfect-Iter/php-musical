...
<head>
    ...
    <link rel="stylesheet" href="http://localhost/musixx/public/assets/css/style.css?12659">
    <title>MUSIXX</title>
</head>
<body>
    <style>
    ...
    <header style="background-color: #3e344e; color: white;">
        ...
        <div class="header-div">
            ...
            <div class="main-nav">
                <div class="nav-item active"><a href="http://localhost/musixx/public/admin/dashboard">Dashboard</a></div>
                <div class="nav-item"><a href="#">Music</a></div>
     
                <div class="nav-item"><a href="#">Artists</a></div>
                <div class="nav-item"><a href="http://localhost/musixx/public/admin/users">Users</a></div>
